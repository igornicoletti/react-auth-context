...
export const formVariants = tv({
  slots: {
    ...
    fieldInput: `block w-full h-10 px-4 sm:text-base rounded-lg focus:outline-none focus:outline-2 focus:-outline-offset-2 bg-dracula-charcoal placeholder:text-dracula-blue focus:outline-dracula-purple`,
    fieldPassword: 'relative',
    fieldButton: 'group absolute top-0 right-0 py-2.5 px-4',
    ...
    submit: `inline-flex w-full h-10 items-center justify-center px-4 uppercase rounded-lg font-semibold bg-dracula-purple hover:bg-dracula-purple/90 ${transitions}`,
  },
})
